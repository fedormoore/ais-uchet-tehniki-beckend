...
@CrossOrigin(origins = {"*"})
@RestController
@RequestMapping("/api/v1/app/material_value_org/disassemble")
...
public class DisassembleController {
    ...
    public List<MaterialValueOrgDto> saveIncome(@JsonView(View.SAVE.class) @Valid @RequestBody(required = false) List<DisassembleDto> disassembleDto) {
        return disassembleService.saveDisassemble(disassembleDto);
    }
