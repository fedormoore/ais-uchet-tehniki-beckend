    ...
    public List<MaterialValueOrgDto> saveIncome(IncomeDto incomeDto, Authentication authentication) {
        try {
            ...
            for (IncomeDto.IncomeSpecDto incomeSpecDto : incomeDto.getSpec()) {
                ...
                materialValueOrgHistoryServiceImpl.saveFromStorageIncome(materialValueOrg, materialValueOrg.getChildren(), reasonContract, HistoryTypeEnum.INCOME.name(), HistoryTypeEnum.INCOME.name(),null, null, null);
                materialValueOrgHistoryServiceImpl.saveFromStorageIncome(materialValueOrg, null, null, HistoryTypeEnum.LOCATION.name(), null, materialValueOrg.getLocation().getId().toString(), null, null);
                materialValueOrgHistoryServiceImpl.saveFromStorageIncome(materialValueOrg, null, null, HistoryTypeEnum.BUDGET_ACCOUNT.name(), null, materialValueOrg.getBudgetAccount().getId().toString(), null, null);
                if (materialValueOrg.getResponsible() != null) {
                    materialValueOrgHistoryServiceImpl.saveFromStorageIncome(materialValueOrg, null, null, HistoryTypeEnum.RESPONSIBLE.name(), null, responsible.getId().toString(), null, null);
                }
                if (materialValueOrg.getOrganization() != null) {
                    materialValueOrgHistoryServiceImpl.saveFromStorageIncome(materialValueOrg, null, null, HistoryTypeEnum.ORGANIZATION.name(), null, materialValueOrg.getOrganization().getId().toString(), null, null);
                }
