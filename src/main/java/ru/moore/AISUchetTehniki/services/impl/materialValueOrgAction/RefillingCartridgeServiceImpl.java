...
public class RefillingCartridgeServiceImpl implements RefillingCartridgeService {
    ...
    public List<MaterialValueOrgDto> saveRefillingCartridge(List<RefillingCartridgeDto> refillingCartridgeDtoList) {
        try {
            ...
            for (RefillingCartridgeDto cartridgeDto : refillingCartridgeDtoList) {
                refillingCartridgeListDto.addAll(cartridgeDto.getCartridge());
            }
