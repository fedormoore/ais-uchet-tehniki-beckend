...
@NoArgsConstructor
@Validated
public class ReasonContractDto {
    ...
    @NotNull(groups = {OnSave.class}, message = "Поле 'counterpartyId' не может быть пустым.")
    ...
    @JsonView({View.SAVE.class})
    private @Valid List<ContractSpecDto> spec;
    ...
    @Data
    @NoArgsConstructor
    public static class ContractSpecDto {
        @JsonView({View.SAVE.class})
